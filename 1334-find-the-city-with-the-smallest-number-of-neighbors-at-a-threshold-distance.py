        ...
        for i in range(n):
            ...
            for j in range(n):
                if i != j and dist[i][j] <= distanceThreshold:
                    reachable += 1
            if min_reachable is None or reachable <= min_reachable:
